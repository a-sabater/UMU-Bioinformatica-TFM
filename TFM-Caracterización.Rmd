...
Estos genes conocidos provienen de un panel de genes generado por Genomics England (https://panelapp.genomicsengland.co.uk/panels/39/gene/IPPK/; 31 de marzo de 2017) para "Neurología y trastornos del desarrollo neurológico". Estos paneles de genes están altamente curados por más de 45 clínicos y científicos. Se trata de un listado de 34 símbolos de genes humanos.

En el siguiente código filtraremos los genes asociados a EP:
...
Para solventar el hecho de que el script pare cuando encuentra un gen que no devuelve información por no formar parte de la base de datos que se pretende consultar,  usaremos una función genérica que itera sobre la lista de genes aplicando las funciones específicas de cada plantilla dentro de las bases de datos que proporciona InterMine:
...
## 1.1 Caracterización mediante la api de HumanMine, que devuelve los términos Human Phenotype (HP) para el listado de genes conocidos
...
El código presentado a continuación devuelve los términos HP para cada gen:
...
## 1.2 Caracterización mediante la api de MouseMine, que devuelve los términos Mammalian Phenotype (MP) deratón para el listado de genes conocidos
...
## 1.3  Caracterización mediante la api de MousePhenotype (IMPC), que devuelve los términos Mammalian Phenotype (MP) de ratón para el listado de genes conocidos
...
## 1.4 Caracterización mediante la api de RatMine, que devuelve los términos Mammalian Phenotype (MP) de rata para el listado de genes conocidos
...
## 1.5 Caracterización mediante la api de FlyMine, que devuelve los términos Fly Anatomy (FBbt) y FlyBase Controlled vocabulary (FBcv) de Drosofila melanogaster para el listado de genes conocidos
...
## 1.6 Caracterización mediante la api de WormMine, que devuelve los términos términos WBPhenotype de C. elegans para el listado de genes conocidos
